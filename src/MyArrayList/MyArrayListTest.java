...
public class MyArrayListTest {
    public static void start() {
        ...
        MyArrayList<Integer> checkingList = new MyArrayList<Integer>();
        checkingList.add(34);
        checkingList.add(7);
        ...
        a.print();
        MyArrayList<Integer> deletingList = new MyArrayList<Integer>();
        deletingList.add(88);
        deletingList.add(7);
        ...
        System.out.print("Adding 100 elements to MyArrayList.MyArrayList\n\t\t");
        for (int i = 0; i < 100; i++) {
            a.add(i);
        }
        System.out.print("Current capacity: " + a.getCurrentCapacity() + "\n\t");
